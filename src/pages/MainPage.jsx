import { Briefcase, Calculator, PencilLine, HardHat, ChevronRight, ArrowLeft } from 'lucide-react'
...
export default function MainPage({ project, rolesData, onSelect, onBack }) {
  return (
    <div>
      <button
        onClick={onBack}
        style={{
          ...
          borderRadius: 8, padding: '5px 11px', background: 'white', marginBottom: 14,
        }}
      >
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', background: '#1a2f45', minHeight: 480 }}>
          ...
          <div style={{ position: 'absolute', top: 22, left: 22, right: 22 }}>
            ...
            <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.72)', marginTop: 5 }}>{project.address}</p>
            <span style={{
          ...
          <div style={{ position: 'absolute', bottom: 20, left: 22, right: 22 }}>
            <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.55)' }}>Mechanical Services — D&E Group</p>
          </div>
        </div>
